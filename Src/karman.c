...
void Slide(Angle* angle){
  ...
  int cnt = 3;
  for(int count = cnt; count < 6; count++)
  {
  ...
  angle->angular_rate_dps[0] = (float)(sum_acc_angle_x/(6-cnt));
  angle->angular_rate_dps[1] = (float)(sum_acc_angle_y/(6-cnt));
  angle->angular_rate_dps[2] = (float)(sum_acc_angle_z/(6-cnt));
  angle->acceleration_g[0] = (float)(sum_acc_x/(6-cnt));
  angle->acceleration_g[1] = (float)(sum_acc_y/(6-cnt));
  angle->acceleration_g[2] = (float)(sum_acc_z/(6-cnt));  
}
